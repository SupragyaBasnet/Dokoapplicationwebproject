...
let new_collections = [
  {
    id: 12,
    name: "Black Full Sleeved t-shirt for women ",
    image: p1_img,
    new_price: 50.0,
    old_price: 80.5,
  },
  {
    id: 35,
    name: "PUMA black sports jacket for kids",
    image: p2_img,
    new_price: 85.0,
    old_price: 120.5,
  },
  ...
  {
    id: 8,
    name: "Floral t-shirt with half sleeve for women",
    image: p4_img,
    new_price: 100.0,
    old_price: 150.0,
  },
  {
    id: 15,
    name: "Black and White marble effect Jacket",
    image: p5_img,
    new_price: 50.0,
    old_price: 80.5,
  },
  {
    id: 2,
    name: "Pink crop-top made up of cotton material for women",
    image: p6_img,
    new_price: 85.0,
    old_price: 120.5,
  },
